...
describe('getHomePosts', () => {
    ...
    it('GIVEN an existent user with posts published and following users WHEN getHomePosts is called it populates the post info and filtrates it THEN returns a populated and formated posts array', () => {
                    ...
                    .then(() => {
                        ...
                        return user2.save()
                            .then(() => {
                                ...
                                const post3Data = { author: user1._id, likes: [], title: 'post-3-test', description: 'post-3-content-test' }
                                return data.posts.create([post3Data, post2Data])
                                    .then(([post3, post2]) => {
                                        return data.posts.create(post1Data)
                                            .then(post1 => {
                                                return getHomePosts(user1._id.toString())
                                                    .then(posts => {
                                                        expect(posts).to.be.an('array')
                                                        expect(posts.length).to.equal(2)

                                                        expect(posts[0].id).to.equal(post1._id.toString())
                                                        expect(posts[0]._id).to.equal(undefined)
                                                        expect(posts[0].likes).to.deep.equal(post1Data.likes)
                                                        expect(posts[0].title).to.equal(post1Data.title)
                                                        expect(posts[0].description).to.equal(post1Data.description)
                                                        expect(posts[0].img).to.equal(post1Data.img)
                                                        ...
                                                        expect(posts[0].author.username).to.equal(user2.username)
                                                        expect(posts[0].author.avatar).to.equal(user2.avatar)
                                                        expect(posts[0].author.id).to.equal(user2._id.toString())
                                                        ...
                                                        expect(posts[1].isLiked).to.be.false
                                                        expect(posts[1].author).to.be.an('object')
                                                        expect(posts[1].author.username).to.equal(user1.username)
                                                        expect(posts[1].author.avatar).to.equal(user1.avatar)
                                                        expect(posts[1].author.id).to.equal(user1._id.toString())
    ...
    it('GIVEN an existent user with no posts published and following users WHEN getHomePosts is called it populates the post info and filtrates it THEN returns a populated and formated posts array', () => {
        const user1Data = { username: 'Test-1', password: 'Test1!', email: 'email@mail.com', following: [], followers: [] }
        const user2Data = { username: 'Test-2', password: 'Test2!', email: 'email2@mail.com', following: [], followers: [], avatar: 'random.com/image.png' }
        const user3Data = { username: 'Test-3', password: 'Test3!', email: 'email3@mail.com', following: [], followers: [] }
                    ...
                    .then(() => {
                        ...
                        return user2.save()
                            .then(() => {
                                const post1Data = { author: user2._id, likes: [user1._id], title: 'post-1-test', description: 'post-1-content-test', img: 'this.link/image.png' }
                                const post2Data = { author: user3._id, likes: [user2._id], title: 'post-2-test', description: 'post-2-content-test' }
                                const post3Data = { author: user2._id, likes: [], title: 'post-3-test', description: 'post-3-content-test' }
                                return data.posts.create([post3Data, post2Data])
                                    .then(([post3, post2]) => {
                                        return data.posts.create(post1Data)
                                            .then(post1 => {
    ...
    it('GIVEN an existent user with posts published and not following any users WHEN getHomePosts is called it populates the post info and filtrates it THEN returns a populated and formated posts array', () => {
        const user1Data = { username: 'Test-1', password: 'Test1!', email: 'email@mail.com', following: [], followers: [] }
        const user2Data = { username: 'Test-2', password: 'Test2!', email: 'email2@mail.com', following: [], followers: [], avatar: 'random.com/image.png' }
        const user3Data = { username: 'Test-3', password: 'Test3!', email: 'email3@mail.com', following: [], followers: [] }
        ...
        return data.users.create([user1Data, user2Data, user3Data])
            .then(([user1, user2, user3]) => {
                const post1Data = { author: user1._id, likes: [user1._id], title: 'post-1-test', description: 'post-1-content-test', img: 'this.link/image.png' }
                const post2Data = { author: user3._id, likes: [user2._id], title: 'post-2-test', description: 'post-2-content-test' }
                const post3Data = { author: user1._id, likes: [], title: 'post-3-test', description: 'post-3-content-test' }
                            ...
                            .then(post1 => {
                                return getHomePosts(user1._id.toString())
                                    .then(posts => {
                                        ...
                                        expect(posts[0].isLiked).to.be.true
                                        expect(posts[0].author).to.be.an('object')
                                        expect(posts[0].author.username).to.equal(user1.username)
                                        expect(posts[0].author.avatar).to.equal(user1.avatar)
                                        expect(posts[0].author.id).to.equal(user1._id.toString())
                                        expect(posts[0].author.password).to.equal(undefined)
                                        expect(posts[0].author.mail).to.equal(undefined)
                                        expect(posts[0].author._id).to.equal(undefined)
                                        expect(posts[0].author.followers).to.equal(undefined)
    ...
    it('GIVEN an existent user with no posts published and not following any users WHEN getHomePosts is called does not find any post THEN returns an empty array', () => {
        const user1Data = { username: 'Test-1', password: 'Test1!', email: 'email@mail.com', following: [], followers: [] }
        const user2Data = { username: 'Test-2', password: 'Test2!', email: 'email2@mail.com', following: [], followers: [], avatar: 'random.com/image.png' }
        const user3Data = { username: 'Test-3', password: 'Test3!', email: 'email3@mail.com', following: [], followers: [] }
    ...
    it('GIVEN a not existent user id WHEN getHomePosts is called does not found the user THEN thorws ExistenceError', () => {
        const fakeId = new data.ObjectId()
        return getHomePosts(fakeId.toString())
            .catch(error => {
